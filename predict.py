#!/usr/bin/env python
"""
Commandline Tool For Doing Predicting Housing Prices:
...
@click.version_option(projlib.__version__)
@click.group()
def cli():
    """CSV Operations Tool
...
def agg(file,groupby, applyname, func):
   ...
   ./csvcli.py cvsops --file ext/input.csv --groupby last_name --applyname count --func npmedian
    ...
    2017-06-22 14:07:52,532 - projlib.utils - INFO - Loading appliable functions/plugins: npmedian
    2017-06-22 14:07:52,533 - projlib.utils - INFO - Loading appliable functions/plugins: npsum
    2017-06-22 14:07:52,533 - projlib.utils - INFO - Loading appliable functions/plugins: numpy
    2017-06-22 14:07:52,533 - projlib.utils - INFO - Loading appliable functions/plugins: tanimoto
    last_name
    eagle    17.0
    lee       3.0
    smith    13.5
